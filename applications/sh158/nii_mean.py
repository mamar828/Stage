...
# Zurflueh width test
# -------------------
# m = Map.load("data/sh158/fit_no_bin/NII_mean.fits").get_masked_region(pyregion.open("data/sh158/target_region.reg"))
...
multifig.y_label = "Structure Function [-]"
# multifig.show()
multifig.save("figures/sh158/nii_mean/str_func_diff_lengths.pdf", dpi=600)
